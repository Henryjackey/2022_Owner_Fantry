...
typedef struct
{
  ...
  pid_type_def chassis_angle_pid;              //follow angle PID.底盘跟随角度pid
	pid_type_def cap_voltage_pid;              //votlage PID
	pid_type_def buffer_pid;                    //buffer PID    缓冲PID
...
extern void chaasis_detect_control(chassis_move_t *chaasis_detect_control);
